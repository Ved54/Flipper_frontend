...
class GYMFitness extends StatefulWidget {
  const GYMFitness({super.key});

  @override
  State<GYMFitness> createState() => _GYMFitnessState();
}

class _GYMFitnessState extends State<GYMFitness> {
  final locationController = TextEditingController();
  String currentLocation = "";

  final typeController = TextEditingController(text: 'Gym & Fitness');
