...
class HobbiesUpload extends StatefulWidget {
  const HobbiesUpload({super.key});

  @override
  State<HobbiesUpload> createState() => _HobbiesUploadState();
}

class _HobbiesUploadState extends State<HobbiesUpload> {
  final locationController = TextEditingController();
  String currentLocation = "";

  final typeController = TextEditingController(text: 'Hobbies');
