...
class MusicalInstruments extends StatefulWidget {
  const MusicalInstruments({super.key});

  @override
  State<MusicalInstruments> createState() => _MusicalInstrumentsState();
}
...
class _MusicalInstrumentsState extends State<MusicalInstruments> {
  ...
  final typeController = TextEditingController(text: 'Musical Instruments');
