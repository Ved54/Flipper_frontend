...
class ViewCycle extends StatefulWidget {
  const ViewCycle({super.key,
  ...
  @override
  State<ViewCycle> createState() => _ViewCycleState();
}

class _ViewCycleState extends State<ViewCycle> {
  ...
  Widget build(BuildContext context) {
    ViewCycle.id = widget.userId;

    final String getUserQuery = '''
     query{
      usersbyid(flipperUser: "${ViewCycle.id}"){
        username
        emailAddress
  }
}
                ...
                children: [
                  Expanded(
                    child: Text(
                      ...
                      '${widget.cycleTitle}', style: TextStyle(fontWeight: FontWeight.w400, fontSize: 18),
                    ),
                  ),
                ],
              ),
                ...
                children: [
                  ...
                  Row(
                    children: [
                      ...
                      SizedBox(width: 20,),
                      Text(
                        '${widget.bikeBrand}', style: TextStyle(fontWeight: FontWeight.w300, fontSize: 15),
                      ),
                    ],
                  ),
                ],
