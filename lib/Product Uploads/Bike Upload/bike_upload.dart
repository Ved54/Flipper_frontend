...
class BikeUpload extends StatefulWidget {
  const BikeUpload({super.key});


  @override
  State<BikeUpload> createState() => _BikeUploadState();
}

class _BikeUploadState extends State<BikeUpload> {
