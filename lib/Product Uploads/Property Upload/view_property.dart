...
class _ViewPropertyState extends State<ViewProperty> {
  ...
  Widget build(BuildContext context) {
    ViewProperty.id = widget.userId;

    final String getUserQuery = '''
     query{
      usersbyid(flipperUser: "${ViewProperty.id}"){
        username
        emailAddress
  }
}
          ...
          children: [
            Padding(
              ...
              child: Container(
                ...
                child: Image(
                  image: NetworkImage(widget.propertyImage),
                ),
              ),
            ),
            Padding(
              ...
              child: Row(
                children: [
                  Text(
                    '₹ ${widget.propertyPrice} /-', style: TextStyle(fontWeight: FontWeight.w500, fontSize: 20),
                  ),
                ],
              ),
            ),
