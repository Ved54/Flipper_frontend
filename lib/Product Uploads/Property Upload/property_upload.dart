...
class _UploadPropertyState extends State<UploadProperty> {
  ...
  Widget build(BuildContext context) {
    ...
    _createPropertyUpload() async {
      var request = http.MultipartRequest('POST', Uri.parse('${httpLinkC}/propertyupload/'));
      ...
      request.files.add(await http.MultipartFile.fromPath('propertyImage', file!.path.toString()));
        ...
        child: Padding(
          ...
          child: ElevatedButton(
            ...
            onPressed: () async{
              ...
              _createPropertyUpload();
              const snack = SnackBar(
                content: Text('Property Uploaded Successfully', style: TextStyle(
                    color: Colors.white),),
