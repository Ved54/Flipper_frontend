...
class ViewAccessory extends StatefulWidget {
  const ViewAccessory(
      {super.key,
  ...
  final String mobileLocation;
  final String mobileImage;
  final String mobilePrice;
  static String id = "";

  @override
  State<ViewAccessory> createState() => _ViewAccessoryState();
}

class _ViewAccessoryState extends State<ViewAccessory> {
  ...
  Widget build(BuildContext context) {
    ViewAccessory.id = widget.userId;

    final String getUserQuery = '''
     query{
      usersbyid(flipperUser: "${ViewAccessory.id}"){
        username
        emailAddress
  }
}
          ...
          children: [
            Padding(
              ...
              child: Container(
                ...
                child: Image(
                  image: NetworkImage(widget.mobileImage),
                ),
              ),
            ),
            Padding(
