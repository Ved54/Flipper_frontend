...
class ViewFashion extends StatefulWidget {
  const ViewFashion(
      {super.key,
        ...
        required this.fashionLocation,
        required this.fashionPrice,
  ...
  final String fashionLocation;
  final String fashionPrice;
  final String fashionImage;
  static String id = "";

  @override
  State<ViewFashion> createState() => _ViewFashionState();
}

class _ViewFashionState extends State<ViewFashion> {
  ...
  Widget build(BuildContext context) {
    ViewFashion.id = widget.userId;

    final String getUserQuery = '''
     query{
      usersbyid(flipperUser: "${ViewFashion.id}"){
        username
        emailAddress
  }
}
          ...
          children: [
            Padding(
              ...
              child: Container(
                ...
                child: Image(
                  image: NetworkImage(widget.fashionImage),
                ),
              ),
            ),
            Padding(
              ...
              child: Row(
                children: [
                  Text(
                    '₹ ${widget.fashionPrice} /-', style: TextStyle(fontWeight: FontWeight.w500, fontSize: 20),
                  ),
                ],
              ),
            ),
