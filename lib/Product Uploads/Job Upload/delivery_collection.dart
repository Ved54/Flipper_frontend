...
class DeliveryCollection extends StatefulWidget {
  const DeliveryCollection({super.key});

  @override
  State<DeliveryCollection> createState() => _DeliveryCollectionState();
}

class _DeliveryCollectionState extends State<DeliveryCollection> {
  ...
  Widget build(BuildContext context) {
    ...
    _createJobUpload() async {
      ...
      request.fields.addAll({
        'flipperUser': "${sp.uid}",
        'jobType': "Delivery and Collection",
        'jobTitle': "${title}",
