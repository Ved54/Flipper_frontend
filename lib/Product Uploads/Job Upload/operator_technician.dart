...
class OperatorTechnician extends StatefulWidget {
  const OperatorTechnician({super.key});

  @override
  State<OperatorTechnician> createState() => _OperatorTechnicianState();
}

class _OperatorTechnicianState extends State<OperatorTechnician> {
  ...
  Widget build(BuildContext context) {
    ...
    _createJobUpload() async {
      ...
      request.fields.addAll({
        'flipperUser': "${sp.uid}",
        'jobType': "Operator and Technician",
        'jobTitle': "${title}",
