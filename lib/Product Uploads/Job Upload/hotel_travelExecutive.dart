...
class HotelTravelExecutive extends StatefulWidget {
  const HotelTravelExecutive({super.key});

  @override
  State<HotelTravelExecutive> createState() => _HotelTravelExecutiveState();
}

class _HotelTravelExecutiveState extends State<HotelTravelExecutive> {
  ...
  Widget build(BuildContext context) {
    ...
    _createJobUpload() async {
      ...
      request.fields.addAll({
        'flipperUser': "${sp.uid}",
        'jobType': "Hotel and Travel Executive",
        'jobTitle': "${title}",
