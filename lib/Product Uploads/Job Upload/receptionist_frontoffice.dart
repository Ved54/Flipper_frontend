...
class ReceptionistFrontOffice extends StatefulWidget {
  const ReceptionistFrontOffice({super.key});

  @override
  State<ReceptionistFrontOffice> createState() => _ReceptionistFrontOfficeState();
}

class _ReceptionistFrontOfficeState extends State<ReceptionistFrontOffice> {
  final locationController = TextEditingController();
  String currentLocation = "";

  final salPeriodController = TextEditingController();
  String salPeriod = "";

  final positionController = TextEditingController();
  String position = "";

  final salRangeController = TextEditingController();
  String salRange = "";
  ...
  Widget build(BuildContext context) {
    ...
    _createJobUpload() async {
      var request = http.MultipartRequest('POST', Uri.parse('${httpLinkC}/jobupload/'));
      request.fields.addAll({
        'flipperUser': "${sp.uid}",
        'jobType': "Receptionist and Front Office",
        'jobTitle': "${title}",
      ...
      request.files.add(await http.MultipartFile.fromPath('jobImage', file!.path.toString()));
    ...
    return Scaffold(
      ...
      body: Padding(
        ...
        child: ListView(
          children: [
            TextField(
              controller: salPeriodController,
              onChanged: (value){
                setState(() {
                  salPeriod = value;
                });
          ...
          child: ElevatedButton(
            ...
            onPressed: () async{
              ...
              const snack = SnackBar(
                content: Text('Job Uploaded Successfully', style: TextStyle(
                    color: Colors.white),),
