...
class DataEntryBackOffice extends StatefulWidget {
  const DataEntryBackOffice({super.key});

  @override
  State<DataEntryBackOffice> createState() => _DataEntryBackOfficeState();
}

class _DataEntryBackOfficeState extends State<DataEntryBackOffice> {
  ...
  Widget build(BuildContext context) {
    ...
    _createJobUpload() async {
      ...
      request.fields.addAll({
        'flipperUser': "${sp.uid}",
        'jobType': "Data Entry and Back Office",
        'jobTitle': "${title}",
