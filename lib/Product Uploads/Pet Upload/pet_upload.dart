...
class PetUpload extends StatefulWidget {
  const PetUpload({super.key});

  @override
  State<PetUpload> createState() => _PetUploadState();
}

class _PetUploadState extends State<PetUpload> {
  ...
  Widget build(BuildContext context) {
    ...
    _createPetUpload() async {
      var request = http.MultipartRequest('POST', Uri.parse('${httpLinkC}/petupload/'));
      ...
      request.files.add(await http.MultipartFile.fromPath('petImage', file!.path.toString()));
          ...
          child: ElevatedButton(
            ...
            onPressed: () async{
              ...
              const snack = SnackBar(
                content: Text('Pet Uploaded Successfully', style: TextStyle(
                    color: Colors.white),),
