...
class ViewElecApp extends StatefulWidget {
  const ViewElecApp(
      {super.key,
        required this.userId,
        required this.elecType,
        required this.elecTitle,
        required this.elecDescription,
        required this.elecLocation,
        required this.elecPrice,
        required this.elecImage});

  final String userId;
  final String elecType;
  final String elecTitle;
  final String elecDescription;
  final String elecLocation;
  final String elecPrice;
  final String elecImage;
  static String id = "";

  @override
  State<ViewElecApp> createState() => _ViewElecAppState();
}

class _ViewElecAppState extends State<ViewElecApp> {
  ...
  Widget build(BuildContext context) {
    ViewElecApp.id = widget.userId;

    final String getUserQuery = '''
     query{
      usersbyid(flipperUser: "${ViewElecApp.id}"){
        username
        emailAddress
  }
}
          ...
          children: [
            Padding(
              ...
              child: Container(
                ...
                child: Image(
                  image: NetworkImage(widget.elecImage),
                ),
              ),
            ),
            Padding(
              ...
              child: Row(
                children: [
                  Text(
                    '₹ ${widget.elecPrice} /-', style: TextStyle(fontWeight: FontWeight.w500, fontSize: 20),
                  ),
                ],
              ),
            ),
