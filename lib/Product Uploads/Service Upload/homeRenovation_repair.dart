...
class HomeRenovationRepair extends StatefulWidget {
  const HomeRenovationRepair({super.key});

  @override
  State<HomeRenovationRepair> createState() => _HomeRenovationRepairState();
}

class _HomeRenovationRepairState extends State<HomeRenovationRepair> {
  final locationController = TextEditingController();
  String currentLocation = "";

  final typeController = TextEditingController(text: 'Home Renovation & Repair');
