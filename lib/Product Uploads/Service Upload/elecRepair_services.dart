...
class ElectronicsRepairServices extends StatefulWidget {
  const ElectronicsRepairServices({super.key});

  @override
  State<ElectronicsRepairServices> createState() => _ElectronicsRepairServicesState();
}

class _ElectronicsRepairServicesState extends State<ElectronicsRepairServices> {
  final locationController = TextEditingController();
  String currentLocation = "";

  final typeController = TextEditingController(text: 'Electronics Repair & Services');
