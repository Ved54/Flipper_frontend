...
class CleaningPestControl extends StatefulWidget {
  const CleaningPestControl({super.key});

  @override
  State<CleaningPestControl> createState() => _CleaningPestControlState();
}

class _CleaningPestControlState extends State<CleaningPestControl> {
  final locationController = TextEditingController();
  String currentLocation = "";

  final typeController = TextEditingController(text: 'Cleaning & Pest Control');
