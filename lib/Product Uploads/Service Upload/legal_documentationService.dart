...
class LegalDocumentationService extends StatefulWidget {
  const LegalDocumentationService({super.key});

  @override
  State<LegalDocumentationService> createState() => _LegalDocumentationServiceState();
}

class _LegalDocumentationServiceState extends State<LegalDocumentationService> {
  final locationController = TextEditingController();
  String currentLocation = "";

  final typeController = TextEditingController(text: 'Legal & Documentation Service');
  ...
  Widget build(BuildContext context) {
    ...
    _createServiceUpload() async {
      ...
      request.fields.addAll({
        'flipperUser': "${sp.uid}",
        'serviceType': "Legal & Documentation Service",
        'serviceTitle': "${title}",
