...
class EducationClasses extends StatefulWidget {
  const EducationClasses({super.key});

  @override
  State<EducationClasses> createState() => _EducationClassesState();
}

class _EducationClassesState extends State<EducationClasses> {
  final locationController = TextEditingController();
  String currentLocation = "";

  final typeController = TextEditingController(text: 'Education & Service');
