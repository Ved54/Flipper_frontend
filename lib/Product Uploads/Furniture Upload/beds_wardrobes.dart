...
class BedsWardrobes extends StatefulWidget {
  const BedsWardrobes({super.key});

  @override
  State<BedsWardrobes> createState() => _BedsWardrobesState();
}

class _BedsWardrobesState extends State<BedsWardrobes> {
  final locationController = TextEditingController();
  String currentLocation = "";

  final typeController = TextEditingController(text: "Beds & Wardrobes");
