...
class SofaDinning extends StatefulWidget {
  const SofaDinning({super.key});

  @override
  State<SofaDinning> createState() => _SofaDinningState();
}

class _SofaDinningState extends State<SofaDinning> {
  final locationController = TextEditingController();
  String currentLocation = "";

  final typeController = TextEditingController(text: "Sofa & Dinning");
