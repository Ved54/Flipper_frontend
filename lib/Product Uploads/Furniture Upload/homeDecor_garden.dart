...
class HomeDecorGarden extends StatefulWidget {
  const HomeDecorGarden({super.key});

  @override
  State<HomeDecorGarden> createState() => _HomeDecorGardenState();
}

class _HomeDecorGardenState extends State<HomeDecorGarden> {
  final locationController = TextEditingController();
  String currentLocation = "";

  final typeController = TextEditingController(text: "Home Decor & Garden");
  ...
  Widget build(BuildContext context) {
    ...
    _createPetUpload() async {
      ...
      request.fields.addAll({
        'flipperUser': "${sp.uid}",
        'furnitureType' : "Home Decor & Garden",
