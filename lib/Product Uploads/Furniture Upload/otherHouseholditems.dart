...
class OtherHouseholdItems extends StatefulWidget {
  const OtherHouseholdItems({super.key});

  @override
  State<OtherHouseholdItems> createState() => _OtherHouseholdItemsState();
}

class _OtherHouseholdItemsState extends State<OtherHouseholdItems> {
  final locationController = TextEditingController();
  String currentLocation = "";

  final typeController = TextEditingController(text: "Other Household Items");
  ...
  Widget build(BuildContext context) {
    ...
    _createPetUpload() async {
      var request = http.MultipartRequest('POST', Uri.parse('${httpLinkC}/furnitureupload/'));
      request.fields.addAll({
        'flipperUser': "${sp.uid}",
        'furnitureType' : "Other Household Items",
        'furnitureTitle': "${title}",
        'furnitureDescription': "${description}",
        'furnitureLocation': "${currentLocation}",
        'furniturePrice' : "${price}"
      });
      request.files.add(await http.MultipartFile.fromPath('furnitureImage', file!.path.toString()));
      ...
      appBar: AppBar(
        ...
        leading: IconButton(
          onPressed: () {
            Navigator.push(
              context,
              MaterialPageRoute(builder: (context) => SelectFurniture()),
            );
          },
          icon: const Icon(
